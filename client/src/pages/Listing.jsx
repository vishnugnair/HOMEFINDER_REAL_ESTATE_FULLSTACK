...
import {FaBath, FaBed, FaChair, FaMapMarkerAlt, FaParking, FaShare} from 'react-icons/fa'; //fashare is the name of the icon.
import { useParams } from 'react-router-dom';
//these four lines for using image swiper.
...
export default function Listing() {
  ...
  useEffect(()=>{
      const fetchListing=async()=>{
        try {
         setLoading(true);
         const res=await fetch(`/api/listing/get/${params.listingId}`)//listingId bcs its mentioned like that in route.
         ...
         setListing(data);//putting all the data in the listing variable.
         setLoading(false);
         setError(false);
        } catch (error) {
          setError(true);
