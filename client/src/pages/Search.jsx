...
export default function Search() {
    ...
    const urlParams=new URLSearchParams(location.search);
     ...
     if(searchTermFromUrl||typeFromUrl||parkingFromUrl||furnishedFromUrl||sortFromUrl||orderFromUrl){
      setSidebardata({
        ...
        parking:parkingFromUrl==='true'?true:false,furnished:furnishedFromUrl==='true'?true:false,
  ...
  const handleSubmit=(e)=>{
    e.preventDefault();
    const urlParams=new URLSearchParams();//these lines of code are building the url.
      ...
      <div className='flex-1'>
        ...
        <div className='p-7 flex flex-wrap gap-4'>
          {!loading&&listings.length===0&&(
            <p className='p-7 text-xl text-slate-700'>No listings found!</p>
          )}
          {loading&&(
